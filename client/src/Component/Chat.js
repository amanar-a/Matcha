    ...
    >
      <div className="ChatHeader">
        <div className="ChatImage" style={friends[UserName].Active ? { "--color-online": "#44db44" } : { "--color-online": "#a5a5a5" }}>
          <ImageLoader src={ctx.cache.chatUserInfo.Images} alt={UserName} style={{ width: "50px", height: "50px", borderRadius: "50%", overflow: "hidden" }} />
        </div>
              ...
              if (msg !== "limit")
                return (
                  <ChatMessage
                    ...
                    removeMessage={() => ctx.ref.removeMessage(UserName, msg.id)}
                  />
                );
              return null;
            })
